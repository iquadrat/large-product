#include <cmath>
#include "vandermonde_det_test.h"

extern const long int vandermonde_exponent_low_high=511;
...
extern const double vandermonde_factor_ln=std::log((double)2)*(double)vandermonde_exponent_low_high;
